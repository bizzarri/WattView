...
These Go stand-alone programs create a simple command line interface for the WattTime system to read real-time information on the USA (and eventually European) Grid.<br />
