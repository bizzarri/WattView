<html>These Go stand-alone programs allow a simple use case for the WattTime system to read real-time information on the USA (and eventually European) Grid.<br />
